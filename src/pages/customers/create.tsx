...
import { ArrowLeft, Users, Mail, MapPin, Building, Check } from 'lucide-react';
...
const steps = [
  { id: 1, title: 'Contact Info', description: 'Basic contact details', icon: <Mail className="h-4 w-4" /> },
  { id: 2, title: 'Location', description: 'Address details', icon: <MapPin className="h-4 w-4" /> },
  { id: 3, title: 'Additional', description: 'Extra information', icon: <Building className="h-4 w-4" /> },
];
      ...
      case 1:
        return (
          <div className="space-y-6">
            ...
            <div>
              <h4 className="text-sm font-medium text-[#777] mb-4 uppercase tracking-wide">Contact & Identity</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[#151515]">
                    Full Name <span className="text-[#16610E]">*</span>
                  </label>
                  <Input
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[#151515]">
                    Email Address <span className="text-[#16610E]">*</span>
                  </label>
                  <Input
                    type="email"
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="text-sm font-medium text-[#151515]">
                    Phone Number <span className="text-[#16610E]">*</span>
                  </label>
                  <Input
                    type="tel"
      ...
      case 2:
        return (
          <div className="space-y-6">
            {/* Location Section */}
            <div>
              <h4 className="text-sm font-medium text-[#777] mb-4 uppercase tracking-wide">Address Information</h4>
              <div className="space-y-5">
                ...
                />
                <div className="space-y-2">
                  <label className="text-sm font-medium text-[#151515]">Street Address</label>
                  <Textarea
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-[#151515]">State / Province</label>
                    <Input
      ...
      case 3:
        return (
          <div className="space-y-6">
            ...
            <div>
              <h4 className="text-sm font-medium text-[#777] mb-4 uppercase tracking-wide">Account Settings</h4>
              <div className="p-6 bg-[#fafaf8] rounded-xl border border-dashed border-[#e5e5e5]">
                <div className="text-center">
                  ...
                  <h5 className="text-lg font-semibold text-[#151515] mb-2">Review Your Information</h5>
                  <p className="text-sm text-[#777] mb-4">Please review all the details before creating the customer</p>

                  <div className="text-left bg-white rounded-lg p-4 text-sm space-y-2">
                    <p><span className="text-[#777]">Name:</span> <span className="font-medium">{formData.name || '-'}</span></p>
                    <p><span className="text-[#777]">Email:</span> <span className="font-medium">{formData.email || '-'}</span></p>
                    <p><span className="text-[#777]">Phone:</span> <span className="font-medium">{formData.phone || '-'}</span></p>
                    <p><span className="text-[#777]">Location:</span> <span className="font-medium">{formData.location || formData.address || '-'}</span></p>
                    <p><span className="text-[#777]">City:</span> <span className="font-medium">{formData.city || '-'}</span></p>
                    <p><span className="text-[#777]">Country:</span> <span className="font-medium">{formData.country || '-'}</span></p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <AppLayout>
      <main className="flex-1 w-full overflow-y-auto px-4 pt-5 pb-5">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Page Header */}
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-[#151515]">Add New Customer</h1>
            <p className="text-[#777] mt-1">Create a new customer account with comprehensive details</p>
          </div>
