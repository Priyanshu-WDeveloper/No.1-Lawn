            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#ececec] mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-[#151515]">{customer.name}</h1>
                    <p className="text-[#777] text-sm">Customer ID: {id}</p>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="mt-2">
                    <span className={`text-lg font-semibold ${customer.balance < 0 ? 'text-red-500' : 'text-green-600'}`}>
                      {customer.balance < 0 ? '-' : ''}${Math.abs(customer.balance).toFixed(2)}
                    </span>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-[#ececec]">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-[#151515]">Contact Information</h3>
                </div>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#151515] font-medium">{customer.name}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#151515] font-medium">{customer.email}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#151515] font-medium">{customer.phone}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-[#ececec]">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-[#151515]">Address Details</h3>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <MapPin className="h-4 w-4 text-[#777] mt-0.5" />
                    <div className="flex-1">
                      <p className="text-sm text-[#777]">Street Address</p>
                      <p className="text-[#151515] font-medium">{customer.address || '-'}</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-[#777]">City</p>
                      <p className="text-[#151515] font-medium">{customer.city || '-'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-[#777]">State</p>
                      <p className="text-[#151515] font-medium">{customer.state || '-'}</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-[#777]">Postal Code</p>
                      <p className="text-[#151515] font-medium">{customer.postalCode || '-'}</p>
                    </div>
                    <div>
                      <p className="text-sm text-[#777]">Country</p>
                      <p className="text-[#151515] font-medium">{customer.country || '-'}</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-[#ececec] md:col-span-2">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-[#151515]">Account Summary</h3>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div>
                    <p className="text-sm text-[#777]">Status</p>
                    <Badge className={`mt-1 ${customer.active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'}`}>
                      {customer.status}
                    </Badge>
                  </div>
                  <div>
                    <p className="text-sm text-[#777]">Created By</p>
                    <p className="text-[#151515] font-medium mt-1">{customer.createdBy}</p>
                  </div>
                  <div>
                    <p className="text-sm text-[#777]">Created At</p>
                    <p className="text-[#151515] font-medium mt-1">{formatDate(customer.createdAt)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-[#777]">Last Updated</p>
                    <p className="text-[#151515] font-medium mt-1">{formatDate(customer.updatedAt)}</p>
                  </div>
                </div>
              </div>
            </div>
