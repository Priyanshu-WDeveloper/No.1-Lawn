      ...
      <div className="h-screen overflow-hidden w-full bg-[#F4F7EF]">
        <div className="flex h-full rounded-[22px] bg-[#f8f8f5] shadow-xl">
          ...
          <main className="flex-1 overflow-y-auto">
            <div className="min-h-full px-4 py-9">
              {/* Header */}
              ...
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                {stats.map((item, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className="rounded-[20px] border border-[#ececec] py-3 shadow-sm"
                    >
              ...
              {/* Footer */}
              <div className="mt-2 border-t border-[#e9e9e9] pt-2 text-center text-[11px] text-gray-500">
                © 2026 GreenGrass Admin Panel. All rights reserved.
              </div>
            </div>
          </main>
        </div>
